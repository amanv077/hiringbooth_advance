                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">                        <div className="flex items-center mb-2">
                        ...
                        <div className="text-gray-700 mb-3 line-clamp-2">
                          {stripHtmlTags(job.description || 'No description available')}
                        </div>                          <div className="flex flex-wrap gap-4 text-sm text-gray-600">
            ...
            <div className="space-y-4 mb-6">
              ...
              {selectedApplication.applicant.userProfile?.skills && (
                <div>
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{stripHtmlTags(selectedApplication.applicant.userProfile.skills)}</p>
                </div>
              )}
              ...
              {selectedApplication.applicant.userProfile?.experience && (
                <div>
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{stripHtmlTags(selectedApplication.applicant.userProfile.experience)}</p>
                </div>
              )}
            </div>
